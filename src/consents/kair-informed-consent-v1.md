---
name: kair-informed-consent
version: 1
requires_signature: true
title: KAIR Information and Consent for Treatment
required_fields:
  ...
  - { key: video_recording_consent, label: "I understand my KAIR sessions will be video recorded for safety purposes during the altered state of consciousness, and consent to the recording, storage, and access policies described above.", kind: yesno, required: true }
  - { key: stability_attestation, label: "I affirm that I am not actively suicidal or dangerous to myself, others, or property, and that I will not become drunk, high, or otherwise under the influence of drugs for the 3 days prior to the start and entire duration of the retreat.", kind: yesno, required: true }
  - { key: outside_therapist_attestation, label: "I confirm I have an individual therapist prior to attending this retreat and will continue working with them (or another therapist) afterward to support my integration and treatment gains.", kind: yesno, required: true }
...
# KAIR Information and Consent for Treatment
...
The treatment approaches feature Eye Movement Desensitization & Reprocessing (EMDR) and Accelerated Resolution Therapy (ART), which are trauma-informed bilateral stimulation therapies. Depending on your KAIR therapist, they may also incorporate additional modalities, including, but not limited to: Internal Family Systems Therapy (IFS), Image Transformation Therapy (ImTT), and numerous other modalities that are known and respected in the therapeutic community.

All KAIR therapists have been certified as Psychedelic Assisted Psychotherapists from the Integrative Psychiatry Institute (IPI), and utilize the above-mentioned trauma therapy model. If it becomes clear that this model is not a good fit, we will discuss this with you and may provide recommendations for how to proceed with treatment in your community.
...
Retreat reservations are booked for full days (up to 6 hours of therapy). The days and times reserved for your retreat are for you and you alone.

## Professional Fees & Payment Methods

For self-pay clients, the fee for your retreat is the rate that was agreed upon with your therapist. Accepted payment methods are credit card, debit card and instant ACH bank transfer.

We also offer payment plans from 6 to 36 months through our third-party provider Affirm. Financing is subject to a 10% increase in the standard rate. All terms and details related to the fulfillment of your payment plan are handled by Affirm and will be shared with you at the time of your loan application.

Please note that we charge in blocks of full days and do not give refunds for hours that are not attended. For example, a full day (up to 6 hours) that is attended for 4 hours will be billed at the full-day rate of $1,850 (or $2,035 through Affirm). We encourage clients to utilize all of the time that is reserved for them to gain the maximum benefits from their retreat experience.
...
For self-pay clients, there is a deposit of one full day ($1,850) required to secure your KAIR retreat payable via credit card, debit card or instant ACH bank transfer.
...
If you need to cancel or reschedule, we ask that you provide us with as much advance notice as possible.

Cancellations prior to 3 weeks before your scheduled retreat are accepted, and you will receive a partial refund (your deposit minus a $100 fee to cover administrative costs). Cancellations and reschedules for any reason within 3 weeks or less of your scheduled start date will result in a forfeit of your deposit.
...
## Video Recording of KAIR Sessions

In psychedelic-assisted psychotherapy clinical trials, video recording sessions is a standard practice for safety during psychedelic therapy. Intensive Therapy Retreats video records all KAIR sessions in order to meet this standard of care and to provide the utmost safety for your experience in an altered state of consciousness. Video recordings are ONLY accessed and reviewed in the event of concerns that arose from a KAIR session. Recordings will NOT be accessed for general supervision, training, or quality control. Recordings are NOT released for personal use or intended as part of the therapeutic process. Because we take your privacy seriously we utilize a recording system with state of the art HIPAA protections. Recordings are only accessible by your KAIR therapist for safety and are maintained for one full year after the date of the recorded session.

## Movement During KAIR Sessions

Your personal movement and bodily expression are valuable aspects of your experience during a KAIR session. However, due to altered states of consciousness that may be induced by ketamine, it's essential to be aware of potential safety risks related to movement. These include, but are not limited to:

1. **Impaired coordination and balance:** Psychedelics can affect your sense of space and proprioception, increasing the risk of falls, stumbles, or difficulty maneuvering.
2. **Dissociation or altered perception:** You may experience a disconnect from your physical body, making it difficult to assess your physical capabilities and limitations.
3. **Spontaneous movement bursts:** Sudden or intense movements can occur, potentially leading to self-harm or injury if not navigated safely.
4. **Intensification of emotional states:** Your emotions can be amplified during a session, potentially prompting impulsive or erratic movements.

To facilitate your safety, your KAIR therapist will remain present throughout the session to offer verbal guidance and gentle physical assistance if needed. (The use of therapeutic touch will be detailed in the section below.) We encourage open communication about your physical needs and discomfort throughout the session. If you feel unstable or unsafe moving in any way, please do not hesitate to inform your therapist.

You are encouraged to explore movement freely within the safe boundaries of the session room. If you choose to leave a session against the advice of your therapist, you release our practice, and any therapists providing services to you, of any liability related to your actions in leaving the session.

## Touch for Physical Safety

Ketamine can alter balance, coordination, and spatial awareness, potentially increasing the risk of falls. You will be carefully monitored throughout the session and encouraged to communicate any dizziness or changes in balance. However, physical support may be required, especially during transitions like standing or walking.
...
We may plan a follow-up check-in after your retreat, which may (or may not) lead to additional check-ins, additional treatment, or referral. Other than this follow-up, your KAIR therapist will not be available to you for ongoing support after the retreat is completed.

For the KAIR Program, we require clients to have an individual therapist prior to attending a retreat. It is also important that you have a therapist who can work with you upon retreat completion to continue your integration processes and to solidify treatment gains.
...
If you would like to authorize your therapist to send you email or leave detailed voicemails that contain your health information, please check the appropriate boxes on the page below. You are not required to authorize the use of email and/or voicemail and a decision not to sign this authorization will not affect your care in any way. If you prefer not to authorize the use of email and/or voicemail, we will use U.S. Mail or telephone to communicate with you.
